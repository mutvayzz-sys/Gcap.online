...
export const communicationPlatforms: readonly PlatformItem[] = [
  ...
  { name: "iMessage / BlueBubbles", category: "channel", description: "Route personal or team Apple-message workflows through a controlled bridge." },
  { name: "WeChat", category: "channel", description: "Reach teams and customers who operate through WeChat channels." },
  { name: "WeCom", category: "channel", description: "Support enterprise WeChat workspaces and internal operations." },
  { name: "QQBot", category: "channel", description: "Connect QQ bot workflows for regional team and community channels." },
  { name: "SMS", category: "channel", description: "Send short operational alerts and approval prompts by text message." },
  { name: "Signal", category: "channel", description: "Use Signal for privacy-sensitive notifications and approvals." },
  { name: "Workplace", category: "channel", description: "Connect Meta Workplace communities and internal team spaces." },
  { name: "Android / Termux", category: "channel", description: "Run mobile-adjacent command workflows through Android and Termux environments." },
  { name: "Voice", category: "channel", description: "Support voice-triggered workflows and spoken operational updates." },
  { name: "Web API", category: "channel", description: "Start and monitor workflows from product surfaces or custom web apps." },
] as const;
