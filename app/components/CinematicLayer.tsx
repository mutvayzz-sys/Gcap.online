...
export default function CinematicLayer() {
  useEffect(() => {
    ...
    // Lenis smooth scroll — static import, no race condition
    ...
    function buildChapters() {
      ...
      secs.forEach((sec) => {
        ...
        btn.innerHTML = `<span class="chapter-label" aria-hidden="true">${label}</span><span class="chapter-dot" aria-hidden="true"></span>`;
    ...
    function initReveals() {
      ...
      // SCROLL BUG FIX: Force-reveal any elements still hidden after 800ms
      // Handles race conditions between Lenis init and IntersectionObserver
      setTimeout(() => {
        document.querySelectorAll<HTMLElement>("[data-reveal], [data-reveal-item]").forEach(el => {
