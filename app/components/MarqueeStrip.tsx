...
import {
  ...
  SiTelegram, SiWhatsapp, SiDiscord, SiAmazon,
} from "react-icons/si";
...
export const ALL_ITEMS: MarqueeItem[] = [
  ...
  { name: "OpenAI", category: "model", description: "OpenAI's model family, including GPT-5.5 via Codex OAuth.", Icon: SiOpenai },
  { name: "Gemini", category: "model", description: "Google's model via AI Studio and CLI OAuth, optimized for multimodal work.", Icon: SiGoogle },
  { name: "Llama", category: "model", description: "Meta's open model, available for local or private deployments.", Icon: SiMeta },
  { name: "AWS Bedrock", category: "model", description: "Enterprise model access via Amazon's Bedrock Converse API.", Icon: SiAmazon },
  ...
  { name: "xAI Grok", category: "model", description: "xAI's Grok model for reasoning-heavy and research workflows.", img: "/icons/integrations/deepseek.svg" },
  { name: "Kimi K2", category: "model", description: "Moonshot AI's Kimi K2 — strong for long document and context-heavy work.", img: "/icons/integrations/kimi.svg" },
  ...
  { name: "MiMo", category: "model", description: "Xiaomi's MiMo model for reasoning and agentic task workflows.", img: "/icons/integrations/minimax.svg" },
  ...
  { name: "Ollama", category: "model", description: "Run local models privately — no data leaves your infrastructure.", img: "/icons/integrations/openrouter.svg" },
  { name: "Arcee AI", category: "model", description: "Enterprise-grade tuned model endpoints via Arcee AI.", img: "/icons/integrations/minimax.svg" },
  { name: "Vercel AI", category: "model", description: "Vercel AI Gateway for multi-provider routing and observability.", img: "/icons/integrations/openrouter.svg" },
  // Channels
      ...
      <div className="marquee-row flex w-max" style={{ animation: `${reverse ? "marquee-reverse" : "marquee"} ${dur}s linear infinite`, animationPlayState: paused ? "paused" : "running" }}>
        {seq.map((item, i) => (
          <button
            ...
            aria-hidden={i >= set.length ? "true" : undefined}
          >
            <div
