  ...
  return (
    <div ref={containerRef}>
      ...
      <div className="bg-[var(--bg-elevated)] border border-[var(--border)] rounded-2xl px-6 py-5 mb-6 flex items-center gap-4">
        ...
        <div>
          <div className="text-[11px] tracking-[1.5px] text-[var(--text-muted)] uppercase mb-0.5">Workflow intake</div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-[13px] text-white/55 leading-relaxed">
                ...
                and an executive summary — coordinated through one reviewed workflow, delivered while you slept.
              </p>
            </div>
          </motion.div>
        )}
