...
import { Brain, CalendarClock, GitFork, Library, RadioTower, ShieldCheck, Wrench } from "lucide-react";
import { productPillars } from "@/src/data/productPillars";
import SectionHeader from "./SectionHeader";

const pillarIcons = [Brain, Library, CalendarClock, Wrench, RadioTower, GitFork, ShieldCheck];
const pillarSpans = [
          ...
          return (
            ...
            >
              ...
              <div className="relative z-10 flex h-full flex-col justify-between gap-8">
                ...
                <div>
                  <h3 className={`${
                    featured ? "text-[30px] md:text-[38px]" : "text-[23px]"
